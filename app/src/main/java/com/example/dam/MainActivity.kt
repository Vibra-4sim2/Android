...
fun NavigationGraph(
    ...
    NavHost(
        ...
        // ✅ NEW: Saved Sorties Screen for offline mode (accessible from splash)
        composable("saved") {
            SavedSortiesScreen(navController = navController)
        }
...
object NavigationRoutes {
    ...
    fun privateChatRoute(
        ...
        val encodedAvatar = java.net.URLEncoder.encode(otherUserAvatar ?: "", "UTF-8")
        return "privateChat/$conversationId/$otherUserId/$encodedName/$encodedAvatar"
    }
